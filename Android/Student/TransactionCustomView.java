...
public class TransactionCustomView extends BaseAdapter {
    ...
    public TransactionCustomView(Context context, List itemName,List orderIds,List orderAmnt,
                                 List itemQnt,List orderDate,List itemPrice,List orderStatus){
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        view = layoutInflater.inflate(R.layout.transactionhistory,null);
        String s1="";
        String s2="";
        String s3="";
